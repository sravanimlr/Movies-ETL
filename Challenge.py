...
#create ETL pipeline function 
def e_t_l(wiki_movies_raw, kaggle_metadata, ratings):
...
#Ratings file transformation 
ratings['timestamp'] = pd.to_datetime(ratings['timestamp'], unit='s')

#Merging wiki movies and kaggle metadata 
...
file_dir = 'C:/Users/Ramana/Desktop'
...
e_t_l(wiki_movies, kaggle_metadata, ratings)
